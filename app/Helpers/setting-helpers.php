...
if (! function_exists('get_option_file')) {
    function get_option_file($key, $defaultValue = null): ?Media
    {
...
if (! function_exists('get_default_setting')) {
    function get_default_setting(string $key): ?array
    {
...
if (! function_exists('footer_copyrights')) {
    ...
    {
        $template = get_option('design.footer_copyrights', 'Copyrights reserved @ :link | :year');
        $name = get_option('app.name');
        $description = get_option('app.description');
        $url = get_option('app.url');
 ...
 * @return array
 */
if (! function_exists('app_env_options')) {
    function app_env_options()
    {
        return [
            [
                'label' => __('Local'),
 ...
 * @return array
 */
if (! function_exists('app_env_values')) {
    function app_env_values()
    {
        return arr_map(app_env_options(), function ($option) {
            return data_get($option, 'value');
        });
    }
}
...
/**
 * get app maintenance driver options
 *
 * @return array
 */
if (! function_exists('app_maintenance_driver_options')) {
    function app_maintenance_driver_options()
    {
        return [
            [
                'label' => __('File'),
 ...
 * @return array
 */
if (! function_exists('app_maintenance_driver_values')) {
    function app_maintenance_driver_values()
    {
        return arr_map(app_maintenance_driver_options(), function ($option) {
            return data_get($option, 'value');
        });
    }
}
...
/**
 * get app maintenance store options
 *
 * @return array
 */
if (! function_exists('app_maintenance_store_options')) {
    function app_maintenance_store_options()
    {
        return [
            [
                'label' => __('File'),
 ...
 * @return array
 */
if (! function_exists('app_maintenance_store_values')) {
    function app_maintenance_store_values()
    {
        return arr_map(app_maintenance_store_options(), function ($option) {
            return data_get($option, 'value');
        });
    }
}
...
/**
 * get app cipher values
 *
 * @return array
 */
if (! function_exists('app_cipher_values')) {
    function app_cipher_values()
    {
        return [
            'AES-256-CBC',
            'AES-128-CBC',
...
/**
 * get app cipher options
 *
 * @return array
 */
if (! function_exists('app_cipher_options')) {
    function app_cipher_options()
    {
        return collect(app_cipher_values())->map(fn($item) => [
            'label' => $item,
            'value' => $item,
        ])->toArray();
    }
...
if (!function_exists("settings_sidebar")) {
    /**
     * Render settings sidebar.
     */
    function settings_sidebar()
    {
        return SettingItem::sidebar();
    }
}

        ...
        <div class="offcanvas offcanvas-start offcanvas-primary expand-lg dashboard-sidebar" id="dashboard-sidebar">
            ...
            <div class="offcanvas-body pb-6">
                <nav class="sidebar-nav">
                    ...
                    @endcan
                    @can('manage_settings')
                        <x-nav-link wire:navigate :href="route('dashboard.translations')" wire:current.exact="active" icon="bi-translate"
                    ...
                    <x-nav-link-collapse
                        ...
                        <x-nav-link wire:navigate :href="route('dashboard.ui.progress')" wire:current.exact="active" icon="bi-bar-chart"
                            :label="__('Progress')" />
                        <x-nav-link wire:navigate :href="route('dashboard.ui.shimmer')" wire:current.exact="active" icon="bi-square-half"
                            :label="__('Shimmer')" />
                        <x-nav-link wire:navigate :href="route('dashboard.ui.select-model')" wire:current.exact="active" icon="bi-mouse-pointer"
                            :label="__('Select model')" />
                        <x-nav-link wire:navigate :href="route('dashboard.ui.models')" wire:current.exact="active" icon="bi-database"
                            :label="__('All Models')" />
                        <x-nav-link wire:navigate :href="route('dashboard.ui.alerts')" wire:current.exact="active" icon="bi-info-circle"
                            :label="__('Alerts')" />
                        <x-nav-link wire:navigate :href="route('dashboard.ui.alpine-sort')" wire:current.exact="active" icon="bi-sort-down"
                            :label="__('Alpine sort')" /> --}}
                    </x-nav-link-collapse>
                    @can('manage_settings')
                        <x-nav-link-collapse
                            ...
                            @can('manage_fonts')
                                <x-nav-link-collapse
                                    ...
                                    :label="__('Typography')"
                                    :open="true"
                                    {{-- :open="request()->routeIs(['dashboard.settings.typography','dashboard.settings.fonts'])" --}}>

				...
				<div class="form-control border-2 border-dashed p-1 rounded-lg">
					<div class="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-5 gap-4"
						...
						<label for="file-{{ $slot['id'] }}"
							x-data="{ uploading: true, progress: 10 }"
							...
							wire:model.live="file" class="hidden">
							<div x-show="uploading" class="progress w-full absolute top-1/2 -translate-y-1/2 start-1/2 -translate-x-1/2" role="progressbar">

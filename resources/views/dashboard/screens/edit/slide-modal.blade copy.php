<div id="edit-slide-{{ $slide['id'] }}" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit slide {{ $slide['id'] }}</h5>
            ...
            <div class="modal-body">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div class="col md:col-span-2">
                        <img src="{{ $slide['url'] }}" class="w-full" alt="">
                    </div>
                    <div class="col">
                        <div class="grid grid-cols-1 gap-3">
                            ...
                            <div class="col">
                                <fgx:select
                                    ...
                                    :label="__('form.time_slots.{{ $slotIndex }}.slides.{{ $slideIndex }}.transition')"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-fg-dismiss="modal">{{ __('Done') }}</button>
            </div>
        </div>
    </div>
</div>
